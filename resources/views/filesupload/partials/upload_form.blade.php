...
<div class="x_panel">
	<div class="x_title">
		...
		<ul class="nav navbar-right panel_toolbox" style="background: #007bff;border-radius: 10px;">										
			<li><a href="{{URL::to('/')}}/template/upload_template.csv" style="color:#FFF"  download>Download Template</a></li>
		</ul>
		
		<div class="clearfix"></div>Note :
		<span style="color:red"> Please download the template and fille the data before the choose the file</span>
	</div>
	<div class="x_content">
